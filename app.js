...
var QLEV = [
	{
		...
		qs: [
			{
				q: "Who founded ITF Taekwon-Do?",
				o: ["Master Kim", "General Choi Hong Hi", "Grand Master Park", "Admiral Yi Soon-Sin"],
				a: 1,
			},
			{
				q: "What does Taekwon-Do literally mean?",
				o: ["Art of Hand and Foot", "Way of the Empty Hand", "Korean Martial Art", "Art of Kicking"],
				a: 0,
			},
			{
				q: "How many tenets of Taekwon-Do are there?",
				o: ["3", "4", "5", "6"],
				a: 2,
			},
			{
				q: "What does a white belt signify?",
				o: ["Danger", "Innocence or lack of knowledge", "Growth", "Maturity"],
				a: 1,
			},
			{
				q: "What is the Korean word for pattern?",
				o: ["Matsogi", "Tul", "Makgi", "Jirugi"],
				a: 1,
			},
			{
				q: "What is the Korean word for uniform?",
				o: ["Dobok", "Sabum", "Tul", "Dan"],
				a: 0,
			},
			{
				q: "What does Junbi mean?",
				o: ["Attention", "Ready", "Begin", "Stop"],
				a: 1,
			},
			{
				q: "What does Sijak mean?",
				o: ["Attention", "Ready", "Begin", "Stop"],
				a: 2,
			},
			{
				q: "What does Charyot mean?",
				o: ["Attention", "Ready", "Begin", "Bow"],
				a: 0,
			},
			{
				q: "What does Kyong-ye mean?",
				o: ["Attention", "Ready", "Bow", "Stop"],
				a: 2,
			},
			{
				q: "What does Gomman mean?",
				o: ["Begin", "Bow", "Stop", "Relax"],
				a: 2,
			},
			{
				q: "What does Haesan mean?",
				o: ["Stop", "Begin", "Class dismissed", "Relax"],
				a: 2,
			},
			{
				q: "What is the Korean for the training hall?",
				o: ["Dobok", "Dojang", "Sabum", "Tul"],
				a: 1,
			},
			{
				q: "What does Kaunde mean?",
				o: ["High", "Low", "Middle", "Outer"],
				a: 2,
			},
			{
				q: "What does Nopunde mean?",
				o: ["Middle", "Low", "Inner", "High"],
				a: 3,
			},
			{
				q: "What does Najunde mean?",
				o: ["High", "Middle", "Low", "Outer"],
				a: 2,
			},
			{
				q: "What does Makgi mean?",
				o: ["Punch", "Block", "Kick", "Strike"],
				a: 1,
			},
			{
				q: "What does Chagi mean?",
				o: ["Block", "Punch", "Strike", "Kick"],
				a: 3,
			},
			{
				q: "What does Jirugi mean?",
				o: ["Block", "Kick", "Punch", "Strike"],
				a: 2,
			},
			{
				q: "Korean term for walking stance?",
				o: ["Annun Sogi", "Niunja Sogi", "Gunnun Sogi", "Moa Sogi"],
				a: 2,
			},
			{
				q: "What are the pre-pattern exercises for white belt called?",
				o: ["Chon-Ji and Dan-Gun", "Saju Jirugi and Saju Makgi", "Tul and Matsogi", "Jirugi and Makgi"],
				a: 1,
			},
			{
				q: "What does Saju mean?",
				o: ["Two directional", "Three directional", "Four directional", "Eight directional"],
				a: 2,
			},
			{
				q: "What does Saju Jirugi mean?",
				o: ["Four directional block", "Four directional kick", "Four directional punch", "Four directional strike"],
				a: 2,
			},
			{
				q: "What does Saju Makgi mean?",
				o: ["Four directional punch", "Four directional block", "Four directional kick", "Four directional strike"],
				a: 1,
			},
			{
				q: "Which tenet means never giving up?",
				o: ["Courtesy", "Integrity", "Perseverance", "Indomitable Spirit"],
				a: 2,
			},
			{
				q: "Which tenet means being honest and having strong moral principles?",
				o: ["Courtesy", "Integrity", "Perseverance", "Self Control"],
				a: 1,
			},
			{
				q: "What does Ap Joomuk mean?",
				o: ["Knifehand", "Forefist", "Palm", "Back fist"],
				a: 1,
			},
			{
				q: "When was the name Taekwon-Do officially recognised?",
				o: ["1945", "1950", "1955", "1966"],
				a: 2,
			},
			{
				q: "What is the Korean for a colour belt grade?",
				o: ["Dan", "Kup", "Sabum", "Tul"],
				a: 1,
			},
			{
				q: "What is the Korean for a black belt degree?",
				o: ["Kup", "Dan", "Sabum", "Dobok"],
				a: 1,
			},
		],
	},
		...
		qs: [
			{
				...
				o: ["Holy warrior", "Heaven and Earth", "The patriot", "Great general"],
				a: 1,
			},
			{
				q: "How many moves does Chon-Ji have?",
				o: ["16", "17", "19", "21"],
				a: 2,
			},
			{
				q: "Which belt requires Chon-Ji?",
				o: ["White belt", "Yellow stripe", "Yellow belt", "Green stripe"],
				a: 1,
			},
			{
				q: "What does a yellow belt signify?",
				o: ["Danger", "Innocence", "Earth from which a plant sprouts", "Maturity"],
				a: 2,
			},
			{
				q: "Who is Dan-Gun named after?",
				o: ["A general", "A monk", "The legendary founder of Korea", "A scholar"],
				a: 2,
			},
			{
				q: "How many moves does Dan-Gun have?",
				o: ["19", "21", "24", "28"],
				a: 1,
			},
			{
				q: "Which belt requires Dan-Gun?",
				o: ["Yellow stripe", "Yellow belt", "Green stripe", "Green belt"],
				a: 1,
			},
			{
				q: "What does the ITF stand for?",
				o: ["International Taekwondo Foundation", "International Taekwon-Do Federation", "International Training Federation", "International Tae-Kwon-Do Forum"],
				a: 1,
			},
			{
				q: "Korean term for L-stance?",
				o: ["Gunnun Sogi", "Niunja Sogi", "Annun Sogi", "Gojung Sogi"],
				a: 1,
			},
			{
				q: "What foot tool is used for a front snap kick?",
				o: ["Heel", "Instep", "Ball of the foot", "Footsword"],
				a: 2,
			},
			{
				q: "What does Baro mean?",
				o: ["Reverse", "Obverse / Return to ready", "High", "Outer"],
				a: 1,
			},
			{
				q: "What does Bandae mean?",
				o: ["Obverse", "Low", "Reverse", "Inner"],
				a: 2,
			},
			{
				q: "What does Sonkal mean?",
				o: ["Fist", "Palm", "Knifehand", "Forearm"],
				a: 2,
			},
			{
				q: "What does Taerigi mean?",
				o: ["Kick", "Block", "Punch", "Strike"],
				a: 3,
			},
			{
				q: "What does Ap mean?",
				o: ["Back", "Side", "Front", "Inner"],
				a: 2,
			},
			{
				q: "What does Dwit mean?",
				o: ["Front", "Side", "Back / rear", "Inner"],
				a: 2,
			},
			{
				q: "What does Yop mean?",
				o: ["Front", "Back", "Inner", "Side"],
				a: 3,
			},
			{
				q: "What does Dollyo Chagi mean?",
				o: ["Side kick", "Turning kick", "Back kick", "Hook kick"],
				a: 1,
			},
			{
				q: "What is the Korean for the ball of the foot?",
				o: ["Baldung", "Balkal", "Apkumchi", "Dwitchook"],
				a: 2,
			},
			{
				q: "What is the Korean for the instep?",
				o: ["Apkumchi", "Baldung", "Balkal", "Dwitchook"],
				a: 1,
			},
			{
				q: "What does Palkup mean?",
				o: ["Knee", "Elbow", "Shoulder", "Wrist"],
				a: 1,
			},
			{
				q: "Korean for sitting stance?",
				o: ["Niunja Sogi", "Gunnun Sogi", "Annun Sogi", "Moa Sogi"],
				a: 2,
			},
			{
				q: "What is the Korean for the footsword?",
				o: ["Apkumchi", "Baldung", "Balkal", "Dwitchook"],
				a: 2,
			},
			{
				q: "What does Dung Joomuk mean?",
				o: ["Forefist", "Palm", "Back fist", "Knifehand"],
				a: 2,
			},
			{
				q: "What does Sonbadak mean?",
				o: ["Knifehand", "Forefist", "Palm", "Back fist"],
				a: 2,
			},
			{
				q: "What does Tulgi mean?",
				o: ["Punch", "Strike", "Thrust", "Kick"],
				a: 2,
			},
			{
				q: "How many patterns are in the ITF Chang-Hon system?",
				o: ["20", "22", "24", "26"],
				a: 2,
			},
			{
				q: "What is the Korean for the inner forearm?",
				o: ["Bakat Palmok", "An Palmok", "Dung Palmok", "Sonkal"],
				a: 1,
			},
			{
				q: "What is the Korean for the outer forearm?",
				o: ["An Palmok", "Bakat Palmok", "Sonbadak", "Palkup"],
				a: 1,
			},
			{
				q: "What does Naeryo mean?",
				o: ["Upward", "Inward", "Downward", "Outward"],
				a: 2,
			},
		],
	},
	{
		...
		qs: [
			{
				q: "Who is Do-San named after?",
				o: ["Ahn Joong-Gun", "Yi Soon-Sin", "Ahn Chang-Ho", "Won-Hyo"],
				a: 2,
			},
			{
				q: "How many moves does Do-San have?",
				o: ["21", "24", "28", "32"],
				a: 1,
			},
			{
				q: "What does a green belt signify?",
				o: ["Innocence", "Growth of the plant", "Danger", "The sky"],
				a: 1,
			},
			{
				q: "Won-Hyo introduced which religion to Korea?",
				o: ["Christianity", "Islam", "Confucianism", "Buddhism"],
				a: 3,
			},
			{
				q: "How many moves does Won-Hyo have?",
				o: ["24", "26", "28", "30"],
				a: 2,
			},
			{
				q: "Which belt requires Do-San?",
				o: ["Yellow belt", "Green stripe", "Green belt", "Blue stripe"],
				a: 1,
			},
			{
				q: "Which belt requires Won-Hyo?",
				o: ["Green stripe", "Green belt", "Blue stripe", "Blue belt"],
				a: 1,
			},
			{
				q: "What was Won-Hyo's role?",
				o: ["A general", "A king", "A Buddhist monk who spread Buddhism in Korea", "A Confucian scholar"],
				a: 2,
			},
			{
				q: "Ahn Chang-Ho (Do-San) was known as?",
				o: ["A great general", "A Korean independence movement leader", "A Buddhist monk", "A Confucian scholar"],
				a: 1,
			},
			{
				q: "3-step sparring in Korean?",
				o: ["Ilbo Matsogi", "Ibo Matsogi", "Sambo Matsogi", "Jayu Matsogi"],
				a: 2,
			},
			{
				q: "2-step sparring in Korean?",
				o: ["Ilbo Matsogi", "Ibo Matsogi", "Sambo Matsogi", "Jayu Matsogi"],
				a: 1,
			},
			{
				q: "1-step sparring in Korean?",
				o: ["Ilbo Matsogi", "Ibo Matsogi", "Sambo Matsogi", "Jayu Matsogi"],
				a: 0,
			},
			{
				q: "Free sparring in Korean?",
				o: ["Ilbo Matsogi", "Sambo Matsogi", "Jayu Matsogi", "Ibo Matsogi"],
				a: 2,
			},
			{
				q: "Foot tool for a turning kick?",
				o: ["Heel", "Instep", "Ball of the foot", "Footsword"],
				a: 2,
			},
			{
				q: "Foot tool for a side kick?",
				o: ["Ball of foot", "Instep", "Heel or footsword", "Toes"],
				a: 2,
			},
			{
				q: "Foot tool for a back kick?",
				o: ["Ball of foot", "Instep", "Heel", "Footsword"],
				a: 2,
			},
			{
				q: "What does Twimyo mean?",
				o: ["Spinning", "Flying or jumping", "Reverse", "Double"],
				a: 1,
			},
			{
				q: "Korean for fixed stance?",
				o: ["Niunja Sogi", "Gojung Sogi", "Annun Sogi", "Nachuo Sogi"],
				a: 1,
			},
			{
				q: "What does Moorup mean?",
				o: ["Elbow", "Wrist", "Knee", "Shoulder"],
				a: 2,
			},
			{
				q: "Korean for bow?",
				o: ["Charyot", "Junbi", "Kyong-ye", "Sijak"],
				a: 2,
			},
			{
				q: "What is a Kyong-go in ITF sparring?",
				o: ["A point", "A warning", "A half point deduction", "Disqualification"],
				a: 1,
			},
			{
				q: "What is a Gam-jeom in ITF sparring?",
				o: ["A warning", "A full point", "A half point deduction", "Disqualification"],
				a: 2,
			},
			{
				q: "How many Kyong-go equal one Gam-jeom?",
				o: ["1", "2", "3", "4"],
				a: 1,
			},
			{
				q: "What does Hosinsul mean?",
				o: ["Sparring", "Pattern", "Self defence techniques", "Destruction"],
				a: 2,
			},
			{
				q: "What does Kyokpa mean?",
				o: ["Sparring", "Pattern", "Self defence", "Destruction or breaking"],
				a: 3,
			},
			{
				q: "What is the Korean command to stop sparring?",
				o: ["Sijak", "Junbi", "Kalyo", "Gomman"],
				a: 2,
			},
			{
				q: "What does Gibon mean?",
				o: ["Advanced", "Basic or fundamental", "Intermediate", "Special"],
				a: 1,
			},
			{
				q: "What does Sine Wave mean in ITF Taekwon-Do?",
				o: ["A type of kick", "The natural up-down motion used to generate power", "A blocking method", "A pattern diagram"],
				a: 1,
			},
			{
				q: "What is the Korean for a release motion?",
				o: ["Baro", "Dollyo", "Jappyosul Tae", "Bandae"],
				a: 2,
			},
			{
				q: "What does Swiyo mean?",
				o: ["Attention", "Ready", "Begin", "Relax / at ease"],
				a: 3,
			},
		],
	},
	{
		...
		qs: [
			{
				q: "Yul-Gok is the Confucius of which country?",
				o: ["China", "Japan", "Korea", "Vietnam"],
				a: 2,
			},
			{
				q: "How many moves does Yul-Gok have?",
				o: ["32", "36", "38", "40"],
				a: 2,
			},
			{
				q: "Who is Yul-Gok named after?",
				o: ["A great general", "Yi I - a great Korean Confucian scholar", "A monk", "A king"],
				a: 1,
			},
			{
				q: "How many moves does Joong-Gun have?",
				o: ["28", "30", "32", "37"],
				a: 2,
			},
			{
				q: "Who is Joong-Gun named after?",
				o: ["Ahn Chang-Ho", "Yi Soon-Sin", "Ahn Joong-Gun", "Won-Hyo"],
				a: 2,
			},
			{
				q: "The 32 moves of Joong-Gun represent?",
				o: ["His rank", "His age at execution", "The year", "His battles"],
				a: 1,
			},
			{
				q: "How many moves does Toi-Gye have?",
				o: ["32", "35", "37", "38"],
				a: 2,
			},
			{
				q: "Toi-Gye is the pen name of which type of person?",
				o: ["A general", "A monk", "A scholar of neo-Confucianism", "A king"],
				a: 2,
			},
			{
				q: "What does a blue belt signify?",
				o: ["Danger", "The sky towards which the plant grows", "Innocence", "Maturity"],
				a: 1,
			},
			{
				q: "Which belt requires Yul-Gok?",
				o: ["Green belt", "Blue stripe", "Blue belt", "Red stripe"],
				a: 1,
			},
			{
				q: "Which belt requires Joong-Gun?",
				o: ["Blue stripe", "Blue belt", "Red stripe", "Red belt"],
				a: 1,
			},
			{
				q: "Which belt requires Toi-Gye?",
				o: ["Blue belt", "Red stripe", "Red belt", "Black stripe"],
				a: 1,
			},
			{
				q: "What does An mean?",
				o: ["Outer", "Side", "Back", "Inner"],
				a: 3,
			},
			{
				q: "What does Bakat mean?",
				o: ["Inner", "Side", "Outer", "Back"],
				a: 2,
			},
			{
				q: "A high section attack reaches?",
				o: ["Shoulder", "Chest", "Eye level and above", "Top of head only"],
				a: 2,
			},
			{
				q: "A middle section attack reaches?",
				o: ["Head", "Between shoulder and waist", "Below the waist", "Chest to chin"],
				a: 1,
			},
			{
				q: "A low section attack reaches?",
				o: ["Waist and above", "Below the waist", "The legs only", "The feet only"],
				a: 1,
			},
			{
				q: "What does Wen mean?",
				o: ["Right", "Left", "Front", "Back"],
				a: 1,
			},
			{
				q: "What does Orun mean?",
				o: ["Left", "Right", "Front", "Back"],
				a: 1,
			},
			{
				q: "What does Dollimyo mean?",
				o: ["Jumping", "Spinning or rotating", "Downward", "Pressing"],
				a: 1,
			},
			{
				q: "Title for a 1st-3rd Dan black belt?",
				o: ["Sabum", "Sahyun", "Boosabum", "Saseong"],
				a: 2,
			},
			{
				q: "Title for a 4th-6th Dan black belt?",
				o: ["Boosabum", "Sahyun", "Sabum", "Saseong"],
				a: 2,
			},
			{
				q: "Title for a 7th-8th Dan?",
				o: ["Sabum", "Boosabum", "Saseong", "Sahyun"],
				a: 3,
			},
			{
				q: "Title for a 9th Dan?",
				o: ["Sabum", "Sahyun", "Boosabum", "Saseong"],
				a: 3,
			},
			{
				q: "What does Sang mean?",
				o: ["Single", "Double or twin", "Triple", "Alternate"],
				a: 1,
			},
			{
				q: "What does Dwitchook mean?",
				o: ["Ball of the foot", "Instep", "Back heel", "Footsword"],
				a: 2,
			},
			{
				q: "What is the Korean for the knee?",
				o: ["Palkup", "Moorup", "Dwitchook", "Apkumchi"],
				a: 1,
			},
			{
				q: "What does Nopunde Dollyo Chagi mean?",
				o: ["Low turning kick", "Middle turning kick", "High turning kick", "Jumping turning kick"],
				a: 2,
			},
			{
				q: "How many Dan grades are there in ITF Taekwon-Do?",
				o: ["7", "8", "9", "10"],
				a: 2,
			},
			{
				q: "In which year was the ITF officially founded?",
				o: ["1955", "1960", "1966", "1972"],
				a: 2,
			},
		],
	},
	{
		...
		qs: [
			{
				q: "Hwa-Rang warriors were from which dynasty?",
				o: ["Koryo", "Joseon", "Silla", "Baekje"],
				a: 2,
			},
			{
				q: "How many moves does Hwa-Rang have?",
				o: ["27", "28", "29", "30"],
				a: 2,
			},
			{
				q: "The 29 moves of Hwa-Rang represent?",
				o: ["His age", "29th infantry division that helped develop TKD", "The year", "His rank"],
				a: 1,
			},
			{
				q: "How many moves does Choong-Moo have?",
				o: ["28", "29", "30", "32"],
				a: 2,
			},
			{
				q: "Who is Choong-Moo named after?",
				o: ["General Kim", "Admiral Yi Soon-Sin", "General Choi", "Ahn Joong-Gun"],
				a: 1,
			},
			{
				q: "Why does Choong-Moo end with a left hand attack?",
				o: ["He was left-handed", "Symbolise his regrettable death before fully showing loyalty", "Tradition", "It is stronger"],
				a: 1,
			},
			{
				q: "What does a red belt signify?",
				o: ["Maturity", "Danger - control and caution required", "Innocence", "The sky"],
				a: 1,
			},
			{
				q: "Which belt requires Hwa-Rang?",
				o: ["Red stripe", "Red belt", "Black stripe", "1st Dan"],
				a: 1,
			},
			{
				q: "Which belt requires Choong-Moo?",
				o: ["Red belt", "Black stripe", "1st Dan", "2nd Dan"],
				a: 1,
			},
			{
				q: "What does Twimyo Dollyo Chagi mean?",
				o: ["Spinning turning kick", "Flying turning kick", "High turning kick", "Double turning kick"],
				a: 1,
			},
			{
				q: "What is the Korean for self defence techniques?",
				o: ["Matsogi", "Hosinsul", "Kyokpa", "Gibon"],
				a: 1,
			},
			{
				q: "What does Naeryo Chagi mean?",
				o: ["Turning kick", "Side kick", "Downward kick", "Hook kick"],
				a: 2,
			},
			{
				q: "What does Bandal Chagi mean?",
				o: ["Turning kick", "Crescent kick", "Side kick", "Hook kick"],
				a: 1,
			},
			{
				q: "What does Dwit Chagi mean?",
				o: ["Side kick", "Turning kick", "Back kick", "Reverse kick"],
				a: 2,
			},
			{
				q: "What is the Korean for the sole of the foot?",
				o: ["Apkumchi", "Baldung", "Balkal", "Balbadak"],
				a: 3,
			},
			{
				q: "What does Niunja Sogi mean?",
				o: ["Walking stance", "Sitting stance", "L-stance", "Fixed stance"],
				a: 2,
			},
			{
				q: "What does Chookyo Makgi mean?",
				o: ["Low block", "Outward block", "Rising block", "Guarding block"],
				a: 2,
			},
			{
				q: "What does Hechyo Makgi mean?",
				o: ["Rising block", "Wedging block", "Guarding block", "Low block"],
				a: 1,
			},
			{
				q: "What does Daebi Makgi mean?",
				o: ["Rising block", "Wedging block", "Guarding block", "Twin block"],
				a: 2,
			},
			{
				q: "What does Sang Palmok Makgi mean?",
				o: ["Rising block", "Twin forearm block", "Wedging block", "Low block"],
				a: 1,
			},
			{
				q: "What is the Korean for the back sole of the foot?",
				o: ["Balbadak", "Dwitchook", "Dwit Kumchi", "Apkumchi"],
				a: 2,
			},
			{
				q: "What does Yop Baldung mean?",
				o: ["Footsword", "Back heel", "Side instep", "Ball of foot"],
				a: 2,
			},
			{
				q: "What is Jappyosul Tae?",
				o: ["A sparring drill", "A release motion", "A pattern", "A stance"],
				a: 1,
			},
			{
				q: "How many Gam-jeom result in disqualification in ITF sparring?",
				o: ["2", "3", "4", "5"],
				a: 2,
			},
			{
				q: "1 point is awarded in sparring for?",
				o: ["Head kick", "Jumping head kick", "Body punch or body kick", "Takedown"],
				a: 2,
			},
			{
				q: "2 points are awarded in sparring for?",
				o: ["Body kick", "Head kick", "Jumping body kick", "Jumping head kick"],
				a: 1,
			},
			{
				q: "3 points are awarded in sparring for?",
				o: ["Head kick", "Jumping body kick", "Jumping or flying head kick", "Takedown"],
				a: 2,
			},
			{
				q: "What does Balk Kut mean?",
				o: ["Ball of the foot", "Heel", "Toes", "Instep"],
				a: 2,
			},
			{
				q: "General Choi Hong Hi passed away in which year?",
				o: ["1999", "2002", "2005", "2008"],
				a: 1,
			},
			{
				q: "In which country was General Choi Hong Hi born?",
				o: ["South Korea", "North Korea", "China", "Japan"],
				a: 1,
			},
		],
	},
	{
		...
		qs: [
			{
				q: "How many moves does Kwang-Gae have?",
				o: ["36", "38", "39", "44"],
				a: 2,
			},
			{
				q: "The 39 moves of Kwang-Gae represent?",
				o: ["His age", "First two figures of 391 AD", "His battles", "His rank"],
				a: 1,
			},
			{
				q: "How many moves does Po-Eun have?",
				o: ["33", "36", "39", "44"],
				a: 1,
			},
			{
				q: "Po-Eun is the pen name of which scholar-poet?",
				o: ["Yi I", "Chong Mong-Chu", "Ahn Chang-Ho", "So-San"],
				a: 1,
			},
			{
				q: "How many moves does Ge-Baek have?",
				o: ["39", "42", "44", "45"],
				a: 2,
			},
			{
				q: "Ge-Baek is named after a general from which kingdom?",
				o: ["Silla", "Koryo", "Baekje", "Joseon"],
				a: 2,
			},
			{
				q: "How many moves does Eui-Am have?",
				o: ["42", "44", "45", "52"],
				a: 2,
			},
			{
				q: "How many moves does Choong-Jang have?",
				o: ["45", "50", "52", "56"],
				a: 2,
			},
			{
				q: "Why does Choong-Jang end with a left hand attack?",
				o: ["His left-handed style", "His tragic death at age 27 in prison", "Respect for the king", "His final battle"],
				a: 1,
			},
			{
				q: "How many moves does Juche have?",
				o: ["32", "38", "44", "45"],
				a: 2,
			},
			{
				q: "What does Juche mean?",
				o: ["Self reliance - a Korean philosophical concept", "A great battle", "The Korean people", "National unity"],
				a: 0,
			},
			{
				q: "How many moves does Yoo-Sin have?",
				o: ["56", "61", "68", "72"],
				a: 2,
			},
			{
				q: "Yoo-Sin is named after a general from which dynasty?",
				o: ["Baekje", "Joseon", "Silla", "Koryo"],
				a: 2,
			},
			{
				q: "How many moves does Moon-Moo have?",
				o: ["56", "61", "68", "72"],
				a: 1,
			},
			{
				q: "How many moves does So-San have?",
				o: ["61", "68", "72", "75"],
				a: 2,
			},
			{
				q: "The 72 moves of So-San represent?",
				o: ["His battles", "His age when he entered the priesthood", "His rank", "The year"],
				a: 1,
			},
			{
				q: "How many moves does Se-Jong have?",
				o: ["20", "22", "24", "28"],
				a: 2,
			},
			{
				q: "King Se-Jong invented what in 1443?",
				o: ["The compass", "The Korean alphabet (Hangul)", "Gunpowder", "The armoured battleship"],
				a: 1,
			},
			{
				q: "How many moves does Tong-Il have?",
				o: ["49", "52", "56", "61"],
				a: 2,
			},
			{
				q: "What does Tong-Il represent?",
				o: ["A great battle", "The reunification of Korea", "A famous king", "The Korean alphabet"],
				a: 1,
			},
			{
				q: "How many moves does Sam-Il have?",
				o: ["29", "30", "33", "36"],
				a: 2,
			},
			{
				q: "The 33 moves of Sam-Il represent?",
				o: ["The 33 patriot signatories of the March 1st independence movement", "His age", "His battles", "The 33rd infantry"],
				a: 0,
			},
			{
				q: "The 49 moves of Yon-Gae represent?",
				o: ["His age", "Last two figures of 649 AD", "His battles", "The year Korea united"],
				a: 1,
			},
			{
				q: "How many moves does Ul-Ji have?",
				o: ["36", "40", "42", "44"],
				a: 2,
			},
			{
				q: "How many moves does Choi-Yong have?",
				o: ["40", "44", "46", "49"],
				a: 2,
			},
			{
				q: "What ready posture does Kwang-Gae begin with?",
				o: ["Parallel Stance with Heaven Hand", "Closed Ready Stance B", "Warrior Ready Stance A", "Parallel Ready Stance"],
				a: 0,
			},
			{
				q: "The 24 patterns represent what?",
				o: ["24 hours in one day or General Choi's lifespan", "24 letters of the Korean alphabet", "24 students of General Choi", "24 battles"],
				a: 0,
			},
			{
				q: "How many points should be considered when performing a pattern?",
				o: ["7", "8", "9", "10"],
				a: 2,
			},
			{
				q: "General Choi Hong Hi was born in which year?",
				o: ["1915", "1918", "1920", "1922"],
				a: 1,
			},
			{
				q: "How many volumes in General Choi's Encyclopaedia of Taekwon-Do?",
				o: ["9", "12", "15", "24"],
				a: 2,
			},
		],
	},
	{
		...
		qs: [
			{
				q: "What rank did General Choi Hong Hi hold when he founded the ITF?",
				o: ["9th Dan", "7th Dan", "8th Dan", "10th Dan"],
				a: 0,
			},
			{
				q: "In which country was the ITF officially founded in 1966?",
				o: ["South Korea", "Canada", "USA", "North Korea"],
				a: 1,
			},
			{
				q: "What military unit did General Choi use to develop early Taekwon-Do?",
				o: ["29th Infantry Division", "1st Infantry Division", "Hwa-Rang Corps", "Oh Do Kwan"],
				a: 0,
			},
			{
				q: "General Choi published the first TKD encyclopaedia in which year?",
				o: ["1959", "1965", "1972", "1983"],
				a: 1,
			},
			{
				q: "The name Taekwon-Do was officially recognised on which date?",
				o: ["11th April 1955", "1st March 1945", "15th August 1955", "11th April 1965"],
				a: 0,
			},
			{
				q: "Which pattern has the most movements?",
				o: ["So-San with 72", "Yoo-Sin with 68", "Moon-Moo with 61", "Tong-Il with 56"],
				a: 0,
			},
			{
				q: "What ready posture does Juche begin with?",
				o: ["Parallel Stance with Twin Side Elbow", "Closed Ready Stance A", "Warrior Ready Stance B", "Parallel Stance with Heaven Hand"],
				a: 0,
			},
			{
				q: "The diagram of Yul-Gok represents what?",
				o: ["Scholar", "Expansion of territory", "Loyalty", "Homogenous race"],
				a: 0,
			},
			{
				q: "The diagram of Tong-Il symbolises what?",
				o: ["The homogenous race", "The unification of Korea", "Baekdu Mountain", "The Korean alphabet"],
				a: 0,
			},
			{
				q: "What does the diagram of Kwang-Gae represent?",
				o: ["Expansion and recovery of lost territory", "The kings throne", "Military discipline", "Loyalty to the king"],
				a: 0,
			},
			{
				q: "Which of these is NOT one of the 5 tenets?",
				o: ["Respect", "Courtesy", "Integrity", "Perseverance"],
				a: 0,
			},
			{
				q: "What are the 5 tenets in correct order?",
				o: [
					"Courtesy, Integrity, Perseverance, Self Control, Indomitable Spirit",
					"Integrity, Courtesy, Perseverance, Self Control, Indomitable Spirit",
					"Courtesy, Perseverance, Integrity, Self Control, Indomitable Spirit",
					"Self Control, Courtesy, Integrity, Perseverance, Indomitable Spirit",
				],
				a: 0,
			},
			{
				q: "What are the 5 tenets in correct Korean order?",
				o: [
					"Ye Ui, Yom Chi, In Nae, Guk Gi, Baekjool Boolgool",
					"Ye Ui, Yom Chi, Guk Gi, In Nae, Baekjool Boolgool",
					"Guk Gi, Ye Ui, Yom Chi, In Nae, Baekjool Boolgool",
					"In Nae, Ye Ui, Yom Chi, Guk Gi, Baekjool Boolgool",
				],
				a: 0,
			},
			{
				q: "Which pattern ready posture signifies a sword drawn on the right side?",
				o: ["Yoo-Sin", "Sam-Il", "Choi-Yong", "Juche"],
				a: 0,
			},
			{
				q: "Sam-Il commemorates which event?",
				o: ["1st March 1919 Korean independence movement", "15th August 1945 liberation", "1st January 1919", "1st April 1919"],
				a: 0,
			},
			{
				q: "What does Narani Sogi mean?",
				o: ["Walking stance", "L-stance", "Parallel stance", "Sitting stance"],
				a: 2,
			},
			{
				q: "What does Waebal Sogi mean?",
				o: ["Fixed stance", "Closed stance", "One-leg stance", "Diagonal stance"],
				a: 2,
			},
			{
				q: "What does Moa Sogi mean?",
				o: ["One-leg stance", "Closed stance", "Fixed stance", "Parallel stance"],
				a: 1,
			},
			{
				q: "What does Nachuo Sogi mean?",
				o: ["Fixed stance", "Low stance", "Walking stance", "Rear foot stance"],
				a: 1,
			},
			{
				q: "What does Balbadak mean?",
				o: ["Back heel", "Ball of the foot", "Sole of the foot", "Instep"],
				a: 2,
			},
			{
				q: "What does Twimyo Bandae Dollyo Chagi mean?",
				o: ["Jumping turning kick", "Flying reverse turning kick", "Spinning hook kick", "Flying side kick"],
				a: 1,
			},
			{
				q: "How many Gam-jeom result in disqualification in ITF competition?",
				o: ["2", "3", "4", "5"],
				a: 2,
			},
			{
				q: "What is the Korean for the toes as a foot tool?",
				o: ["Apkumchi", "Balk Kut", "Baldung", "Dwitchook"],
				a: 1,
			},
			{
				q: "What does Eui-Am represent?",
				o: ["A general", "The pen name of Son Byong-Hi, leader of the 1919 independence movement", "A Buddhist monk", "A Confucian scholar"],
				a: 1,
			},
			{
				q: "Choi-Yong is named after a general from which dynasty?",
				o: ["Silla", "Baekje", "Koryo", "Joseon"],
				a: 2,
			},
			{
				q: "Ul-Ji is named after a general famous for defeating which invaders?",
				o: ["Japanese", "Mongol", "Chinese (Sui dynasty)", "Manchurian"],
				a: 2,
			},
			{
				q: "What does the diagram of Po-Eun represent?",
				o: ["Expansion", "Loyalty", "Scholar", "Reunification"],
				a: 1,
			},
			{
				q: "Moon-Moo is named after which King of Silla?",
				o: ["Se-Jong", "Kwang-Gae", "Moon-Moo - the 30th King of Silla", "Yoo-Sin"],
				a: 2,
			},
			{
				q: "What does the pattern Ge-Baek diagram represent?",
				o: ["Military discipline and honour", "A scholar", "Reunification", "Loyalty to the king"],
				a: 0,
			},
			{
				q: "General Choi Hong Hi held which rank at the time of his passing?",
				o: ["8th Dan", "9th Dan", "10th Dan", "7th Dan"],
				a: 2,
			},
		],
	},
	{
		...
		qs: [
			{
				q: "What is the exact diagram shape of Toi-Gye?",
				o: ["A straight line", "A cross", "The Chinese character for scholar (士)", "A square"],
				a: 2,
			},
			{
				q: "Which pattern has the same number of moves as Dan-Gun?",
				o: ["Chon-Ji", "Do-San", "None - Dan-Gun is unique at 21", "Won-Hyo"],
				a: 2,
			},
			{
				q: "Kwang-Gae was a king who reigned for how many years?",
				o: ["19 years", "39 years", "22 years", "28 years"],
				a: 1,
			},
			{
				q: "What is the correct sine wave for a middle section punch in walking stance?",
				o: ["Up-down only", "Down only", "Up-up-down", "No sine wave"],
				a: 2,
			},
			{
				q: "Which of these patterns does NOT have a jumping technique?",
				o: ["Hwa-Rang", "Choong-Moo", "Toi-Gye", "Won-Hyo"],
				a: 3,
			},
			{
				q: "In ITF patterns, what does the diagram of Chon-Ji represent?",
				o: ["A cross representing the four directions", "Heaven and Earth - a plus sign (+)", "Two parallel lines", "A circle"],
				a: 1,
			},
			{
				q: "What ready posture is used for Chon-Ji?",
				o: ["Closed Ready Stance A", "Parallel Ready Stance B", "Parallel Ready Stance A", "Warrior Ready Stance"],
				a: 2,
			},
			{
				q: "General Choi Hong Hi was imprisoned by the Japanese in which city?",
				o: ["Seoul", "Pyongyang", "Tokyo", "Beijing"],
				a: 1,
			},
			{
				q: "What is the Korean for an obverse punch?",
				o: ["Bandae Jirugi", "Baro Jirugi", "Nopunde Jirugi", "Dollyo Jirugi"],
				a: 1,
			},
			{
				q: "How many moves does Yon-Gae have?",
				o: ["44", "49", "52", "56"],
				a: 1,
			},
			{
				q: "The ready posture for Won-Hyo is?",
				o: ["Parallel Ready Stance A", "Closed Ready Stance A", "Warrior Ready Stance B", "Parallel Stance with Heaven Hand"],
				a: 1,
			},
			{
				q: "What is the first move of Chon-Ji?",
				o: ["High block", "Low block in walking stance", "Middle punch", "Inner forearm block"],
				a: 1,
			},
			{
				q: "What does the term 'Yonsok' mean?",
				o: ["Slow", "Continuous or combination", "Reverse", "Single"],
				a: 1,
			},
			{
				q: "What does 'Kyocha Joomuk' mean?",
				o: ["Twin fist", "Cross fist", "Double punch", "Hammer fist"],
				a: 1,
			},
			{
				q: "Which pattern was originally called Ko-Dang in some ITF organisations?",
				o: ["Eui-Am", "Juche", "Choong-Jang", "Ul-Ji"],
				a: 1,
			},
			{
				q: "What is the correct foot position for a side kick chamber?",
				o: ["Toes pointing down", "Foot parallel to floor", "Knee raised to the side with foot pulled back", "Heel leading"],
				a: 2,
			},
			{
				q: "What does 'Kyocha Sogi' mean?",
				o: ["L-stance", "Cross stance", "One-leg stance", "Closed stance"],
				a: 1,
			},
			{
				q: "In which year did General Choi Hong Hi first demonstrate Taekwon-Do to South Korean President Syngman Rhee?",
				o: ["1952", "1954", "1958", "1960"],
				a: 1,
			},
			{
				q: "How many moves does Sam-Il have and what specifically do they represent?",
				o: [
					"33 moves - the 33 patriot signatories of the March 1st 1919 declaration",
					"30 moves - the 30th anniversary of independence",
					"36 moves - 36 years of occupation",
					"29 moves - the 29th infantry division",
				],
				a: 0,
			},
			{
				q: "What is 'Bakat Palmok Kaunde Makgi'?",
				o: ["Inner forearm high block", "Outer forearm middle block", "Knifehand low block", "Palm middle block"],
				a: 1,
			},
			{
				q: "In ITF Taekwon-Do, what is the correct breath control during a technique?",
				o: ["Breathe in on execution", "Exhale sharply on execution, inhale on return", "Hold breath throughout", "Breathe continuously"],
				a: 1,
			},
			{
				q: "What does 'Sonkal Dung' mean?",
				o: ["Knifehand", "Ridge hand (reverse knifehand)", "Palm", "Back fist"],
				a: 1,
			},
			{
				q: "Which pattern diagram looks like the Korean letter for King (王)?",
				o: ["Yul-Gok", "Toi-Gye", "Joong-Gun", "Hwa-Rang"],
				a: 0,
			},
			{
				q: "What is 'Opun Sonkut Tulgi'?",
				o: ["Knifehand strike", "Four-finger thrust", "Palm strike", "Back fist strike"],
				a: 1,
			},
			{
				q: "General Choi learned Calligraphy and Taekkyeon from which master?",
				o: ["Master Kim", "Mr Han Il Dong", "Grand Master Park", "Master Yoon"],
				a: 1,
			},
			{
				q: "What is 'Nopunde Bakat Palmok Makgi'?",
				o: ["High inner forearm block", "High outer forearm block", "High knifehand block", "High palm block"],
				a: 1,
			},
			{
				q: "How many moves does Kwang-Gae have and what do they represent?",
				o: [
					"39 moves - first two figures of 391 AD when he recovered lost territory",
					"44 moves - his age at death",
					"36 moves - years of his reign",
					"42 moves - the year he became king",
				],
				a: 0,
			},
			{
				q: "What does 'Miro Makgi' mean?",
				o: ["Rising block", "Pushing block", "Hooking block", "Pressing block"],
				a: 1,
			},
			{
				q: "In ITF competition, a competitor receives how many Kyong-go before a point is deducted?",
				o: ["1", "2", "3", "4"],
				a: 1,
			},
			{
				q: "What is the name of the ITF first World Championships and where were they held?",
				o: [
					"1st World TKD Championships - Montreal 1974",
					"1st ITF World Championships - Montreal 1974",
					"1st ITF World Championships - Seoul 1972",
					"1st World TKD Championships - New York 1970",
				],
				a: 1,
			},
		],
