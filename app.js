...
var PATS = [
	{
		...
		video: "https://www.youtube.com/embed/VC6Dg0-ykTg",
	},
	{
		id: "",
		name: "Saju Makgi",
...
var QLEV = [
	{
		...
		qs: [
			...
			{ q: "How many tenets of Taekwon-Do?", o: ["3", "4", "5", "6"], a: 2 },
			{
				q: "What does a white belt signify?",
				o: ["Danger", "Innocence", "Growth", "Maturity"],
				a: 1,
			},
			{
				q: "Korean word for pattern?",
				o: ["Matsogi", "Tul", "Makgi", "Jirugi"],
				a: 1,
			},
			{
				q: "Korean word for uniform?",
			...
			},
			{
				...
				o: ["A general", "A monk", "Legendary founder of Korea", "A scholar"],
				a: 2,
			},
			{
				q: "Do-San is named after?",
			...
			{
				q: "Won-Hyo introduced which religion?",
			...
			{
				q: "When was TKD officially recognised?",
				o: ["1945", "1950", "1955", "1960"],
				a: 2,
			},
		],
	},
	{
		...
		qs: [
			{
				q: "Yul-Gok is Confucius of which country?",
			...
			{
				q: "32 moves of Joong-Gun represent?",
			...
			},
			{
				...
				o: [
					"Danger",
					"The sky towards which the tree grows",
					"Innocence",
					"Maturity",
				],
				a: 1,
			...
			},
			{
				...
				o: ["Reverse", "Obverse/Return", "High", "Outer"],
				a: 1,
			},
			{
			...
			},
			{
				...
				o: ["Block", "Kick", "Punch/Twist", "Strike"],
				a: 2,
			},
			{
				q: "What does Taerigi mean?",
				o: ["Kick", "Block", "Strike", "Thrust"],
				a: 2,
			},
			{
	...
	{
		label: "Blue/Red to Black Tag",
		grades: "3rd-1st Kup",
		emoji: "Red",
		color: "#e8193c",
		qs: [
			{
				q: "Hwa-Rang is from which dynasty?",
			...
			{
				q: "29 moves of Hwa-Rang represent?",
				o: ["His age", "29th infantry division", "The year", "His rank"],
				a: 1,
			},
			{
			...
			{
				q: "Why does Choong-Moo end with left attack?",
				o: [
					"He was left-handed",
					"Symbolise his regrettable death",
					"Tradition",
					"It is stronger",
				],
				a: 1,
			},
			{
				...
				o: ["Maturity", "Danger - caution and control", "Innocence", "The sky"],
				a: 1,
			},
			{
				q: "Title for 1st-3rd Dan?",
			...
			{
				q: "Foot tool for back kick?",
				o: ["Ball of foot", "Instep", "Heel", "Footsword"],
				a: 2,
			},
			{
				q: "A high attack reaches?",
				o: ["Shoulder", "Chest", "Eye level", "Top of head"],
				a: 2,
			},
			{
			...
			{ q: "What does Yop mean?", o: ["Front", "Side", "Back", "Inner"], a: 1 },
			{
				q: "Korean for bow?",
	...
	},
	{
		...
		qs: [
			...
			{
				q: "72 in So-San represents?",
				o: [
					"His battles",
					"His age entering the priesthood",
					"His rank",
					"The year",
				],
				a: 1,
			...
			{
				q: "King Se-Jong invented in 1443?",
				o: [
					"The compass",
					"The Korean alphabet",
					"Gunpowder",
			...
			{
				q: "Title for 7th-8th Dan?",
				o: ["Sabum", "Boosabum", "Sahyun (Master)", "Saseong"],
				a: 2,
			},
			{
				q: "Title for 9th Dan?",
				o: ["Master", "Sahyun", "Saseong (Grand Master)", "Sabum"],
				a: 2,
			},
			{ q: "Patterns in Chang-Hon system?", o: ["20", "22", "24", "26"], a: 2 },
			{
				q: "Sam-Il commemorates?",
				o: [
					"1st Jan 1919",
					"1st March 1919",
					"1st April 1919",
			...
			{
				q: "39 moves of Kwang-Gae represent?",
				o: [
					"His age",
					"First two figures of 391 AD",
					"His battles",
					"His rank",
				],
				a: 1,
			...
			{
				q: "Yon-Gae 49 moves represent?",
				o: [
					"His age",
					"Last two figures of 649 AD",
					"His battles",
					"The year Korea united",
				],
				a: 1,
			},
		],
	},
	{
		...
		qs: [
			{
				q: "What rank did General Choi Hong Hi hold when he founded ITF Taekwon-Do?",
			...
			},
			{
				...
				o: [
					...
					"International Taekwondo Foundation",
					"International Training Federation",
					"International Tae-Kwon-Do Forum",
				],
				a: 0,
			},
			{
				q: "General Choi published the first TKD encyclopaedia in which year?",
				o: ["1965", "1972", "1983", "1959"],
				a: 0,
			},
			{
			...
			{
				q: "General Choi passed away in which year?",
				o: ["2002", "1999", "2005", "2000"],
				a: 0,
			},
			{
				q: "The 24 patterns represent what?",
				o: [
					"24 hours one day or General Choi's life",
					"24 letters of the Korean alphabet",
					"24 students of General Choi",
					"24 battles of Korean history",
				],
				a: 0,
			},
			{
			...
			},
			{
				...
				o: [
					"Parallel Stance with Twin Side Elbow",
			...
			{
				q: "Which pattern ends with a left hand attack?",
				o: [
					"Choong-Moo to symbolise Admiral Yi Soon-Sin's regrettable death",
					"Hwa-Rang to symbolise the youth warrior",
					"Toi-Gye to symbolise the scholar",
					"Joong-Gun to symbolise his execution",
				],
				a: 0,
			},
			{
			...
			{
				q: "How many points should be considered when performing patterns?",
				o: ["9", "7", "8", "10"],
				a: 0,
			},
			{
			...
			{
				q: "What title is given to a 4th Dan black belt?",
				o: ["Sabum - Instructor", "Boosabum", "Sahyun", "Saseong"],
				a: 0,
			},
			{
				q: "At what Dan grade does Sahyun Master begin?",
				o: ["7th Dan", "6th Dan", "8th Dan", "5th Dan"],
				a: 0,
			},
			{
			...
			},
			{
				...
				o: [
					"The natural up-down motion to generate power",
					"A type of kick combination",
					"A blocking method",
					"A pattern diagram shape",
				],
				a: 0,
			},
			{
				q: "What does Naeryo mean?",
				o: ["Downward", "Upward", "Inward", "Outward"],
				a: 0,
			},
			{
				q: "What does Twimyo mean?",
				o: ["Flying or Jumping", "Spinning", "Reverse", "Fast"],
				a: 0,
			},
			{
				q: "What is the Korean for a release motion?",
				o: ["Jappyosul Tae", "Baro", "Dollyo", "Bandae"],
				a: 0,
			},
			{
				q: "What is the Korean for self defence techniques?",
				o: ["Hosinsul", "Matsogi", "Makgi", "Tulgi"],
				a: 0,
			},
			{
				q: "What is the Korean for a warning in ITF sparring?",
				o: ["Kyong-go", "Gam-jeom", "Shijak", "Kalyo"],
				a: 0,
			},
			{
				q: "What does Gam-jeom mean in ITF competition?",
				o: ["Deduction of half a point", "Disqualification", "Warning", "Stop"],
				a: 0,
			},
			{
				q: "What is the Korean command to stop sparring?",
				o: ["Kalyo", "Gomman", "Shijak", "Sijak"],
				a: 0,
			},
			{
				q: "How many Gam-jeom result in disqualification?",
				o: ["4", "3", "2", "5"],
				a: 0,
			},
			{
				q: "What is the Korean for the outer forearm?",
				o: ["Bakat Palmok", "An Palmok", "Dung Palmok", "Ap Palmok"],
				a: 0,
			},
			{
				q: "What does Dollyo Chagi mean?",
				o: ["Turning Kick", "Reverse Kick", "Hook Kick", "Crescent Kick"],
				a: 0,
			},
			{
				q: "What is the Korean for the ball of the foot?",
				o: ["Apkumchi", "Dwitchumok", "Baltung", "Balkal"],
				a: 0,
			},
			{
				q: "What does Gibon mean?",
				o: ["Basic or Fundamental", "Advanced", "Intermediate", "Special"],
				a: 0,
			},
			{
				q: "What does Kyokpa mean?",
				o: ["Destruction or breaking", "Sparring", "Pattern", "Self defence"],
				a: 0,
			},
			{
				q: "What is the Korean for one-step sparring?",
				o: ["Ilbo Matsogi", "Sambo Matsogi", "Jayu Matsogi", "Ibo Matsogi"],
				a: 0,
			},
			{
				...
				o: [
					"Ye Ui Yom Chi In Nae Baekjool Boolgool Guk Gi",
			...
			{
				q: "Choong-Jang ends with a left hand attack - why?",
				o: [
					"The tragedy of his death at 27 in prison",
					"His left-handed fighting style",
